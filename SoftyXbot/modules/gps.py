...
@Softy.on_message(filters.command(["gps"]))
...
#     await message.delete()
    ...
    try:
        ...
        """
        geolocator = Nominatim(user_agent="legend-Softy")
#         zoom=[0-18]
...
@Softy.on_message(filters.command(["distance"]))
...
# Softy.add_handler(MessageHandler(gps))     
# Softy.add_handler(MessageHandler(distance))
