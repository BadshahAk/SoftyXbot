...
import random
from SoftyXbot import telethn as client
...
async def mentionall(event):
    ...
    if event.pattern_match.group(1) and event.is_reply:
        ...
        if msg == None:
            return await event.respond(
                "/tagall Softy 👈 𝐊𝐨𝐧𝐬𝐢 𝐩𝐫𝐚𝐣𝐚𝐭𝐢 𝐤𝐞 𝐥𝐨𝐠 𝐡𝐨, 𝐦𝐬𝐠 𝐝𝐚𝐥𝐧𝐚 𝐬𝐢𝐤𝐡𝐨😂"
            )
    else:
        return await event.respond(
            "/tagall Softy 👈 𝐊𝐨𝐧𝐬𝐢 𝐩𝐫𝐚𝐣𝐚𝐭𝐢 𝐤𝐞 𝐥𝐨𝐠 𝐡𝐨, 𝐦𝐬𝐠 𝐝𝐚𝐥𝐧𝐚 𝐬𝐢𝐤𝐡𝐨😂"
