...
from SoftyXbot.modules.alive import Softy
import SoftyXbot.modules.sql.userinfo_sql as sql
...
from SoftyXbot.__main__ import STATS, TOKEN, USER_INFO
from SoftyXbot.modules.disable import DisableAbleCommandHandler
from SoftyXbot.modules.helper_funcs.chat_status import sudo_plus
from SoftyXbot.modules.helper_funcs.extraction import extract_user
from SoftyXbot.modules.sql.global_bans_sql import is_user_gbanned
from SoftyXbot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Softybotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url=f"https://t.me/Love_X_frnd"
                            ),
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/Love_X_frnd"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Love_X_frnd"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/Love_X_frnd"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
