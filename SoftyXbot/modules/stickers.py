...
from SoftyXbot.events import register as Softy
...
def convert_gif(input):
    """ғᴜɴᴄᴛɪᴏɴ ᴛᴏ ᴄᴏɴᴠᴇʀᴛ ᴍᴘ4 ᴛᴏ ᴡᴇʙᴍ(ᴠᴘ9)"""
...
async def drawText(image_path, text):
    ...
    fnt = "ariel.ttf" if os.name == "nt" else "./SoftyXbot/modules/resources/default.ttf"
