...
import SoftyXbot.modules.no_sql.users_db as user_db 
from SoftyXbot import pbot as Softy
from SoftyXbot import DEV_USERS, LOGGER as  logger, OWNER_ID, dispatcher
from SoftyXbot.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from SoftyXbot.modules.no_sql.users_db import get_all_users
...
@dev_plus
@Softy.on_message(filters.command(["bchat","broadcastgroups"]) & filters.user(OWNER_ID) & filters.reply)
...
@dev_plus
# broadcast
@Softy.on_message(filters.command(["buser","broadcastusers"]) & filters.user(OWNER_ID) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
