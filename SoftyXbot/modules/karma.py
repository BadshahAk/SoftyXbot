...
from SoftyXbot import OWNER_ID, pbot
from SoftyXbot.utils.admins import can_change_info
from SoftyXbot.utils.errors import capture_err
from SoftyXbot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|Softy|thank you|gud|thankyou|love|pro)$"
