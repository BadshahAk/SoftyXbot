...
from SoftyXbot.modules.nightmode import button_row
from SoftyXbot import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./SoftyXbot/resources/fonts/*")
